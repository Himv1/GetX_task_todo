    ...
    return Scaffold(
      body: SafeArea(
        child: Obx(() {
          ...
          var copletedTasks = homeCtrl.getTotalDoneTask();
          var liveTasks = createdTasks - copletedTasks;
          var percent = (copletedTasks / createdTasks * 100).toStringAsFixed(0);
          return ListView(
            children: [
              Padding(
              ...
              Padding(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    _buildStatus(Colors.orange, copletedTasks, 'Comleted'),
